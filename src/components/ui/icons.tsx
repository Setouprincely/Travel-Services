...
export const Car = ({ className }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 14l-1.5-1.5c-.828-.828-2.172-.828-3 0L13 14m6 0v4a2 2 0 01-2 2h-1a2 2 0 01-2-2v-1H7v1a2 2 0 01-2 2H4a2 2 0 01-2-2v-4m17 0H5m14 0l-1.5-1.5c-.828-.828-2.172-.828-3 0L13 14M5 14l1.5-1.5c.828-.828 2.172-.828 3 0L11 14m-6 0v4" />
  </svg>
);
